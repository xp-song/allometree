...
#'
#' Fit data to a specified allometric equation, for one species.
...
#'
#' Wrapper function that runs `sp_modelfit()` across multiple species. Data is fit to
#' specified allometric equations for each species, as defined within
